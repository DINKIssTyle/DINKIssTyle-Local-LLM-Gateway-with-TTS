...
(function attachDKSTI18n(global) {
    const translations = {
        "ko": {
            ...
            "action.logout": "로그아웃",
            "action.logoutCurrentDevice": "현재 기기 로그아웃",
            ...
            "setting.enableTools.desc": "모든 모델 공급자가 앱 안에서 실행되는 웹 검색, 메모리 등의 도구를 사용합니다.",
            ...
            "setting.webTheme.label": "테마",
            "setting.webTheme.desc": "시스템 설정에 맞추거나 채팅창 테마를 고정합니다.",
            "setting.webTheme.option.auto": "자동",
            "setting.webTheme.option.dark": "다크",
            "setting.webTheme.option.light": "라이트",
            ...
            "status.noFinalAnswer": "모델이 생각 또는 도구 사용 후 최종 답변을 반환하지 않았습니다.",
            "status.finalAnswerRecoveryFailed": "최종 답변 생성이 3차례 재시도 후에도 실패했습니다.",
            ...
            "setting.ttsEngine.desc": "서버 관리창에서 'Enable TTS & Vector DB'가 켜져 있을 때 사용할 엔진과 재생 방식을 선택합니다.",
            "setting.ttsEngine.option.supertonic": "Supertonic 3 (서버)",
            "setting.ttsEngine.option.supertonicOnDevice": "Supertonic 3 (온디바이스)",
            ...
            "setting.speed.label": "합성 속도",
            "setting.speed.desc": "Supertonic 고유의 발화 속도입니다. 0.7은 느리게, 2.0은 빠르게 합성합니다. 자연스러운 기본값은 0.9입니다.",
            "setting.ttsLang.label": "TTS 언어",
            "setting.ttsLang.desc": "선호하는 언어를 선택하세요.",
            "setting.chunkSize.label": "스마트 청킹",
            "setting.chunkSize.desc": "문단 단위로 읽고, 이 길이를 넘는 긴 문단만 안전하게 나눕니다. (추천: 300)",
            "setting.steps.label": "추론 단계(Steps)",
            "setting.steps.desc": "(범위: 1~20, 추천: 2~8, 기본: 5) 높을수록 자연스럽습니다.",
            "setting.threads.label": "CPU 스레드",
            "setting.threads.desc": "(범위: 1~4, 기본: 4) TTS 생성에 사용할 스레드 수입니다.",
        ...
        "en": {
            ...
            "action.logoutCurrentDevice": "Log Out This Device",
            ...
            "setting.enableTools.label": "Enable App Tools",
            "setting.enableTools.desc": "Let every configured model provider use web, memory, and other tools executed inside this app.",
            ...
            "setting.webTheme.label": "Theme",
            "setting.webTheme.desc": "Follow your system setting or pin the chat to a fixed theme.",
            "setting.webTheme.option.auto": "Auto",
            "setting.webTheme.option.dark": "Dark",
            "setting.webTheme.option.light": "Light",
            ...
            "setting.autoDismissMobileKeyboard.label": "Auto-hide Software Keyboard",
            "setting.autoDismissMobileKeyboard.desc": "On iOS and Android mobile devices, remove focus from the message field after sending so the keyboard closes automatically.",
            ...
            "status.noFinalAnswer": "The model used reasoning or tools but did not return a final answer.",
            "status.finalAnswerRecoveryFailed": "Final answer generation failed after 3 retry attempts.",
            ...
            "setting.ttsEngine.desc": "Choose the engine and playback behavior available when 'Enable TTS & Vector DB' is turned on in Server Manager.",
            "setting.ttsEngine.option.supertonic": "Supertonic 3 (Server)",
            "setting.ttsEngine.option.supertonicOnDevice": "Supertonic 3 (On Device)",
            "setting.ttsEngine.option.os": "OS TTS",
            ...
            "setting.speed.label": "Synthesis Speed",
            "setting.speed.desc": "Native Supertonic speaking speed. 0.7 is slower and 2.0 is faster; the natural default is 0.9.",
            ...
            "setting.chunkSize.desc": "Reads by paragraph and only splits long paragraphs above this limit. (Recommended: 300)",
            "setting.steps.label": "Inference Steps",
            "setting.steps.desc": "(Range: 1~20, Recommended: 2~8, Default: 5) Higher = more natural voice",
            "setting.threads.label": "CPU Threads",
            "setting.threads.desc": "(Range: 1~4, Default: 4) CPU threads for TTS generation",
            ...
            "chat.passiveSyncTool": "Another window is using an app tool...",
